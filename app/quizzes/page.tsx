...
const categoryNotes: Record<string, string> = {
  ...
  "Согласен/не согласен": "Быстрые утверждения, где видно совпадения и различия.",
  "Было/не было": "Список общих историй, которые уже случились или ждут своего момента.",
  "Фото-ответы": "Викторины, где вместо текста нужно отвечать фотографиями.",
};
