...
import { normalizeMemoryMediaValueForStorage } from "@/lib/memoryStorage";
  ...
  async function addMemory() {
    ...
    try {
      ...
      const payload = {
        ...
        image: normalizeMemoryMediaValueForStorage(encodeMemoryMedia({ photoUrl, voiceUrl, attachments })),
      };
